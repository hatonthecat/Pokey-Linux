...
void usage __P((void));
void chat_logf __P((const char *fmt, ...));
void chat_fatal __P((int code, const char *fmt, ...));
...
void chat_logf __V((const char *fmt, ...))
{
    va_list args;
