...
// note that this should not exceed 31, ever.
#define NSIS_MAX_INST_TYPES 4
...
#define NSIS_CONFIG_COMPRESSION_SUPPORT
  ...
  // footprint using bzip2 is also approximately 1kb more than zlib.
...
// NSIS_CONFIG_XPSTYLE_SUPPORT enables support for Windows XP new style.
// adds about 1k, for no real benefit, so we keep this disabled by default.
